...
import com.shky.network.vpn.core.server.ServerImpl;
import com.shky.network.vpn.core.tunnel.NetworkTunnel;

@SuppressWarnings("serial")
public class TunnelTestGUIServer extends JFrame implements ActionListener, TunnelTestGUI {
	...
	private NetworkTunnel m_crypto;
	
	public TunnelTestGUIServer()
	{
		super("ServerImpl");
		...
		//Start / Stop
		m_btnStart = new JButton("Start ServerImpl");
		m_btnStop = new JButton("Stop ServerImpl");
	...
	private void start()
	{
		...
		{
			printf("ServerImpl unable to start.");
			m_btnStart.setEnabled(true);
		}		
	}
