...
import com.shky.network.vpn.core.client.ClientImpl;
import com.shky.network.vpn.core.client.Client;


@SuppressWarnings("serial")
public class TunnelTestGUIClient extends JFrame implements ActionListener, TunnelTestGUI {
	...
	private Client m_crypto;
	
	public TunnelTestGUIClient()
	{
		super("ClientImpl");
